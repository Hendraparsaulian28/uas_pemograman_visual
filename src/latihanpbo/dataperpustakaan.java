...
public class dataperpustakaan extends javax.swing.JFrame {
    ...
    /**
     * Creates new form dataperpustakaan
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, 540, -1));
        ...
        getContentPane().add(buttonsimpan, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 440, 113, 50));
        ...
        getContentPane().add(buttonedit, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 450, 113, 33));
        ...
        getContentPane().add(buttonhapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 450, 113, 33));
        ...
        getContentPane().add(buttonrefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 450, 130, 32));
        ...
        getContentPane().add(buttonkeluar, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 443, 113, 40));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/CRUD-01-01_1.jpg"))); // NOI18N
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -50, 960, 620));
    ...
    private void tabel_data_perpustakaanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabel_data_perpustakaanMouseClicked
        ...
        String nama = (String) tabel_data_perpustakaan.getValueAt(i,2);
        txtnama.setText(nama);
        
        String kode_buku = (String) tabel_data_perpustakaan.getValueAt(i,3);
        txtkodebuku.setText(kode_buku);
        
        String judul_buku = (String) tabel_data_perpustakaan.getValueAt(i,4);
        txtjudulbuku.setText(judul_buku);
        
        
        String jumlah_buku = (String)tabel_data_perpustakaan.getValueAt(i,5);
        txtjumlahbuku.setText(jumlah_buku);
        
        String status = (String) tabel_data_perpustakaan.getValueAt(i,6);
    ...
    private void buttoneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttoneditActionPerformed
     // TODO add your handling code here:
        ...
        try {
        Statement statement = (Statement) koneksi.getConnection().createStatement();
        statement.executeUpdate("UPDATE tb_perpustakaan SET nama='"+nama+"',kode_buku='"+kode_buku+"',judul_buku='"+judul_buku+"',jumlah_buku='"+jumlah_buku+"', status='"+status+"' WHERE id='"+id+"'");
    ...
    private void buttonhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonhapusActionPerformed
        ...
        try {
            Statement statement = (Statement) koneksi.getConnection().createStatement();
            statement.executeUpdate("delete from tb_perpustakaan where id='"+id+"'");
